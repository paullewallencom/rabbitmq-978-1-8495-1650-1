...
public final class Constants {
	...
	public static final String RECIPE_NR   = "08/03"; 
	public static final String HEADER      = " ** RabbitmqCookBook - Recipe number " + RECIPE_NR + ". Testing ack and prefetch performances. **";
